...
public abstract class NodeBasic extends JButton implements INode {
    ...
    public void drop(DropTargetDropEvent dtde) {
        ...
        App.app.infoBar.setOperation("“" + this.getText() + "”连线成功");
//        getRootPane().repaint();
    }

    public final class MouseApdaterListener extends MouseInputAdapter {
//        int MULTI_CLICK_INTERVAL = Integer.parseInt(Toolkit
//                .getDefaultToolkit().getDesktopProperty("awt.multiClickInterval").toString());
//        private Timer timer;
...
//                App.app.myPanel.repaint();
                ...
                nodeParent.repaint();
                nodeParent = null;
//                System.out.println(nodeBasic.getRootPane());
//                System.out.println(nodeBasic.getParent());
//                System.out.println(nodeBasic.getFocusCycleRootAncestor());
            }
        }
        ...
        public void mouseDragged(MouseEvent e) {
            if (e.getButton() != 1) {
                ...
                point = newPoint;
//                this.nodeBasic.getRootPane().repaint();
